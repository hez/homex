defmodule Homex.Entity do
  ...
  defmacro __using__(opts) do
    quote bind_quoted: [opts: opts], generated: true do
      ...
      @update_interval opts[:update_interval] |> dbg()
  ...
  def handle_info({topic, payload}, entity) do
    {:noreply, entity.impl.handle_message({topic, payload}, entity) |> execute_change()}
  end

  def handle_info(:update, entity) do
    {:noreply, entity |> entity.impl.handle_timer() |> execute_change()}
  end
